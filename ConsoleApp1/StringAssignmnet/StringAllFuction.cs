...
{
    //1.Write a program and make use of all string functions in it
    class StringAllFuction
    {
        static void Main(string[] args)
        {
            ...
            firstname = "Snehal Kawade";
            lastname = "Kawade";


           // Console.WriteLine(firstname.Clone()); // Make String Clone

            Console.WriteLine(firstname.CompareTo(lastname));
            //Compare two string value and returns 0 for true and 1 for false
            

             Console.WriteLine(firstname.Contains("hal")); //Check whether specified value exists or not in string

              Console.WriteLine(firstname.EndsWith("e")); //Check whether specified value is the last character of string

              Console.WriteLine(firstname.Equals(lastname)); //Compare two string and returns true and false


            //Console.WriteLine(firstname.GetHashCode()); //Returns HashCode of String

           // Console.WriteLine(firstname.GetType()); //Returns type of string

           // Console.WriteLine(firstname.GetTypeCode()); //Returns type of string
            ...
            Console.WriteLine(firstname.Remove(5)); //Deletes all the characters from begining to specified index.
